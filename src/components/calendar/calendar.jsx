...
class Calendar extends Component {
  ...
  saveEvent(time, date, weekNumber) {
    ...
    dataCopy[objectIndex].content = {...dataCopy[objectIndex].content, [time]: this.state.eventInput};
  ...
  deleteEvent(time, date, weekNumber) {
    ...
    let dataCopy = Object.assign(this.state.data);
    dataCopy[objectIndex].content = {...dataCopy[objectIndex].content, [time]: ""};
    const contentTimeSlots = Object.getOwnPropertyNames(dataCopy[objectIndex].content);
    contentTimeSlots.forEach(x => {
      if(dataCopy[objectIndex].content[x] === "") {
        delete dataCopy[objectIndex].content[x];
  ...
  render() {
                        ...
                        <div className="modal-dialog">
                          <div className="modal-content">
                            <div className="modal-header">
                              <h5 className="modal-title">Modify Event - {this.currentMonth + " " + x.date + ", " + this.currentYear + " - " + c} </h5>
                              <button
                                type="button"
                                className="close"
                                data-dismiss="modal"
    ...
    {
      return (<div className="row p-0 m-0 justify-content-center align-items-center l-loader"><i className="fa fa-spinner fa-pulse fa-3x fa-fw"></i>
